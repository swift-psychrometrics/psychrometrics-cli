...
struct PoundsRemovedCommand: AsyncParsableCommand {
  ...
  @Flag(name: .long, help: "Add more verbose printing")
  var verbose: Bool = false

  @Argument(
    help: "The grains to calculate, either one value as the delta-grains or two values used to calculate the delta-grains"
  )
  var grains: [Double]
